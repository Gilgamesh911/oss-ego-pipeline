...
![抽帧总览](../previews/sample_05.jpg)

[原始输出](sample_05.json) · [独立工程核查](sample_05.checks.json)

## 独立视觉复核

清洁水槽主题正确；90段动作合并后N=63，证据时间44/90合规；末段把拿起展开毛巾误写成擦水槽。

原始文件任务文字：居家生活 / 清洁厨房水槽；这是标签一致性参照，未经专家确认时不当作正式动作/难度真值。

总览0–428秒持续清洁双槽、水龙头和抹布；部分窗称水槽为金属容器。424–426秒手持展开毛巾再移开，未见接触水槽擦拭。

| 抽查动作序号（从0开始） | 视觉支持判断 | 理由 | 证据 |
|---|---|---|---|
| 0 | supported | 0–2秒双手握住并移起锅盖。 | [邻帧](../previews/sample_05_action_000.jpg) |
| 45 | supported | 176–178秒钢丝球从水槽内移向两槽之间的边缘。 | [邻帧](../previews/sample_05_action_045.jpg) |
| 89 | unsupported | 424–426秒拿起展开毛巾并移开，画面不支持所称擦拭水槽边缘。 | [邻帧](../previews/sample_05_action_089.jpg) |
