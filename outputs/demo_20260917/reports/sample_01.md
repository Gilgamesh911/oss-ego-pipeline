...
![抽帧总览](../previews/sample_01.jpg)

[原始输出](sample_01.json) · [独立工程核查](sample_01.checks.json)

## 独立视觉复核

正确识别餐桌擦拭和餐具移位；后窗把擦桌附近动作称为擦碗；N=11仍可能高估重复清洁阶段。

0–42秒抽帧显示穿粉色衣服的人持抹布擦餐桌，并移动碗盘/筷子。

| 抽查动作序号（从0开始） | 视觉支持判断 | 理由 | 证据 |
|---|---|---|---|
| 0 | supported | 0–4秒从门口地面视角移动到餐桌附近。 | [邻帧](../previews/sample_01_action_000.jpg) |
| 5 | supported | 18–22秒右手持布擦桌，左手整理桌上物品。 | [邻帧](../previews/sample_01_action_005.jpg) |
| 10 | supported | 40–42秒右手仍持布接触桌面。 | [邻帧](../previews/sample_01_action_010.jpg) |
